...
//  O merge sort é um algoritmo de ordenação que utiliza a técnica de divisão e conquista.
void mergesort(int *v, int n);

// O sort é uma função auxiliar que ordena o vetor v[i..f] em ordem crescente.
void sort(int *v, int *c, int i, int f);

// O merge é uma função auxiliar que combina os vetores v[i..m] e v[m+1..f] em ordem crescente.
